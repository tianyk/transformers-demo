...
# 这里 sentiment-analysis 为预训练模型的任务名称，当前 sentiment-analysis 任务使用的是 distilbert/distilbert-base-uncased-finetuned-sst-2-english 模型
...
# device=0 表示使用第一个 GPU 设备。在Apple Silicon 芯片上，还可以传 device="mps"，他表示使用 Apple的MPS(Metal Performance Shaders) 框架。
